...
import com.Ashish.utilities.MonitoringMail;
import com.Ashish.utilities.TestConfig;
...
public class CustomListeners extends Page implements ITestListener, ISuiteListener {
	...
	public void onFinish(ISuite suite) {
		...
		try {
			messageBody = "http://"+InetAddress.getLocalHost().getHostAddress()+":8080/job/Live%20-%20PageObjectModel/Extent_20Report";
